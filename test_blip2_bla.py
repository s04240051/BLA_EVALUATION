...
def evaluate_vqa(args):
    ...
    for item in tqdm(items):
        ...
        img_path =  "/home/hzhu/project/EMNLP_BLA/datasets/BLA/images/" + str(image_id) + ".jpg" #路径查一下可能不对
    ...
    logdir = "/home/hzhu/project/EMNLP_BLA/BLIP/scripts/yes_or_no_predictions"
...
def test_BLIP2(args):
    ...
    logdir = "/home/hzhu/project/EMNLP_BLA/BLIP/scripts/yes_or_no_predictions"
    file_name = args.file_path.split("/")[-1].split(".")[0] + "_" + prompt_type + model_name +"_predictions.json"
    json.dump(predictions, open(os.path.join(logdir, file_name), "w"), indent=2)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--file_path',type = str,\
        default='/home/hzhu/project/EMNLP_BLA/BLIP/datasets/BLA/original/coordination_captions_gruen_strict.json', \
    ...
    parser.add_argument('--example_file_path',type = str,\
        default='/home/hzhu/project/EMNLP_BLA/BLIP/datasets/BLA/original/relative_clause_captions_gruen_strict.json', \
        help = "path of caption input")
